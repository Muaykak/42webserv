...
#define HTTP_RECV_BUFFER 4096 * 32
#define HTTP_SEND_BUFFER 4096 * 32
#define HTTP_READ_FROM_CGI_BUFFER_SIZE 4096 * 32
#define HTTP_WRITE_TO_CGI_BUFFER_SIZE 4096 * 32
