...
### Contents
- [Signal Handling](#signals-handling) - how my program handles signals
- [EnvpWrapper](#environment-data-handling) - class that handle the easy usage to environment variable data
- [WebServ](#webserv-class---and-all-the-things) - big class that contains everything.
